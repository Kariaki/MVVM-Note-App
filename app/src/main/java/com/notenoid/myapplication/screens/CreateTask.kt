...
import com.notenoid.myapplication.adapters.DoneClickListener
import com.notenoid.myapplication.adapters.TaskEventViewHolder
import com.notenoid.myapplication.adapters.TaskEntity
import com.notenoid.myapplication.db.NoteViewModel
import com.notenoid.myapplication.DateDialog
import com.notenoid.myapplication.entities.TaskEvent
import com.notenoid.myapplication.R
import com.notenoid.myapplication.TaskDialog
    ...
    private val itemClick = object : ItemClickListener() {
        ...
        override fun onLongClick(position: Int) {
            val dialog = DialogHelper.dialog(requireContext(),requireActivity()){
                noteViewModel.deleteEvent(taskEventtems[position])
